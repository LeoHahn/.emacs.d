...
(custom-theme-set-faces
 'minimal
 '(default ((t (:inherit nil :stipple nil :background "#1d1f21" :foreground "burlywood3" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :foundry "nil"))))
 ...
 '(font-lock-builtin-face ((t (:foreground "#5f819d"))))
 '(font-lock-comment-delimiter-face ((default (:inherit (font-lock-comment-face)))))
 '(font-lock-comment-face ((t (:foreground "#b294bb"))))
